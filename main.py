"""Тренировка персонажа с подсчетом урона."""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция рандомного подсчета урона от атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция рандомного подсчета блокированного урона при защите."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Специфичное действие выбранного персонажа."""
    if char_class == 'warrior':
